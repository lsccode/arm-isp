...
void ctrl_channel_process( void )
{
    ...
    if ( CTRL_CMD_CATEGORY_API_COMMAND == cmd.cmd_category ) {
        LOG( LOG_INFO, "api_command: cmd_ctx_id: %u, cmd_type: %u, cmd_id: %u, cmd_direction: %u, cmd_value: %u.", cmd.cmd_ctx_id, cmd.cmd_type, cmd.cmd_id, cmd.cmd_direction, cmd.cmd_value );
        acamera_command( cmd.cmd_ctx_id, cmd.cmd_type, cmd.cmd_id, cmd.cmd_value, cmd.cmd_direction, &ret_value );
        ...
        if ( CTRL_CMD_CATEGORY_API_CALIBRATION == cmd.cmd_category ) {
            ...
            acamera_api_calibration( cmd.cmd_ctx_id, cmd.cmd_type, cmd.cmd_id, cmd.cmd_direction, (void *)p_buf, cmd.cmd_value, &ret_value );
        }
