...
void gamma_contrast_fsm_clear( gamma_contrast_fsm_t *p_fsm )
{
    p_fsm->gain_target = 256;
    p_fsm->gain_avg = 256;
...
uint8_t gamma_contrast_fsm_process_event( gamma_contrast_fsm_t *p_fsm, event_id_t event_id )
{
    uint8_t b_event_processed = 0;
    switch ( event_id ) {
    default:
        break;
    case event_id_gamma_contrast_stats_ready:
        gamma_contrast_process( p_fsm );
