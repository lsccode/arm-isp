...
#define FSM_NAMES {"GENERIC","SENSOR","CMOS","CROP","GENERAL","AE_MANUAL","AWB_MANUAL","COLOR_MATRIX","IRIDIX8_MANUAL","NOISE_REDUCTION","SHARPENING","MATRIX_YUV","GAMMA_MANUAL","MONITOR","SBUF","DMA_WRITER","METADATA","AF_MANUAL","FPGA_DMA_FE"}
...
#define ISP_V4L2_DMA_COHERENT_DUMMY_ALLOC 0
